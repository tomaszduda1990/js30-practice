 const inventors = [
   ...
   const fifteen = inventors.filter(inventor => inventor.passed>= 1900 && inventor.passed<2000);
   ...
   // console.table(fifteen);
    ...
    //  
    // var selector = document.querySelectorAll('.mw-category-group');
    // selector = document.querySelector('.mw-category');
